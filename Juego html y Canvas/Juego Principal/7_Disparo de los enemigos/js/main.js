...
class Enemies {
    ...
    move(){
        this.posX -= this.speed
        //Le damos una posicion en Y para que se muevan con una ligera inclinacion
        this.posY -= 0.20;
        //Si desaparecen en el eje Y los mandamos atras
...
class Bullets {
    ...
    shoot(){
        //Cuando el prota sea detectado la bala cambiara su velocidad dando el efecto de disparo
        this.posX -=10;
        //Le damos una posicion en Y para que tengan una ligera inclinacion 
        this.posY -= 1;
    }
}
...
const printBullets =()=>{
    for(let index =0; index<bullets.length; index++){
        ...
        if(prota.posY >= bullets[index].posY-50 && prota.posY<= bullets[index].posY+50){
            //Si el prota ha sido detectado QUE LAS BALAS CAMBIEN SU VELOCIDAD Y VAYAN PARA ADELANTE EN EL EJE X
            bullets[index].shoot()
        }else{
            //Si el prota no ha sido detectado QUE LAS BALAS MANTENGAN SU POSISCION
