...
//Creamos la clase que seran las balas del personaje
class BulletProta {
    constructor(posX, posY, width, height, color, speed) {
        this.posX = posX,
            this.posY = posY,
    ...
    shootHalf(){
        //Se pone un setInterval para que se dispare cuando el usuario quiera, si se pusiera en la funcion principal se dispararia todo el tiempo
...
//Creamos al instancia de las balas
...
//Creamos un array de las balas del prota para que se muevan con el protagonista
    ...
    document.addEventListener('keydown', (event) => {
        ...
        if (event.key === 'w' || event.key === 'W') {
            if (prota.posY > 0) {
                ...
                //Le damos movimiento a las balas para que se muevan junto con el prota
            ...
            if (prota.posY < canvas.height - prota.height) {
                ...
                //     index.posY +=prota.speed
                // })   
                //Tambien se puede hacer con un for/for of
        ...
        //Creamos una condicion para que las balas se disparen
        else if(event.key === ' '){
...
const principal = () => {
    ...
    printEnemies()
    printBullets()
    //Invocamos al metodo que pinta la bala del personaje
